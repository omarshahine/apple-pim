...
export const tools = [
...

  {
    name: "apple-pim",
    description:
      "PIM system management. Actions: status (check each domain's permissionStatus), authorize (request permissions), config_show (view config), config_init (discover calendars/lists), schema (show input schema).",
    inputSchema: {
      type: "object",
      properties: {
        action: {
